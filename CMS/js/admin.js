...
(function (global, factory) {
    ...
    var SidebarSearch = /*#__PURE__*/function () {
        ...
        _proto.search = function search() {
            ...
            if (endResults.length === 0) {
                ...
                endResults.each(function (i, result) {
                    $__default['default'](SELECTOR_SEARCH_RESULTS_GROUP).append(_this2._renderItem(result.name, result.link, result.path,result.id));
                });
            }
        ...
        _proto._parseItem = function _parseItem(item, path) {
            ...
            itemObject.id = id;
            if (item.name !== "") {
                const found = SearchItems.find(element => element.name == itemObject.name);
        ...
        _proto._renderItem = function _renderItem(name, link, path, id) {
            var _this4 = this;
            ...
            var idd = "#apage" + id;
            return "<a href=\"" + link + "\" onclick=\"highlightTreemenu('" + idd +"')\" class=\"list-group-item\">\n        <div class=\"search-title\">\n          " + name + "\n        </div>\n        <div class=\"search-path\">\n          " + path + "\n        </div>\n      </a>";
        };
